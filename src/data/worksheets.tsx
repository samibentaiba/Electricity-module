    ...
    exercises: [
      {
        ...
        solutionFormula: "I_1 + I_2 - I_3 = 0 \\newline V - R_1 I_1 - R_3 I_3 = 0",
      ...
      },
      {
        ...
        solutionFormula: "V_{th} = V'_{th} + V''_{th} \\newline R_{eq} = R_1 || R_2",
    ...
    exercises: [
      {
        ...
        solutionFormula: "E_{th} = \\frac{R_2}{R_1 + R_2} \\cdot E \\newline R_{th} = \\frac{R_1 \\cdot R_2}{R_1 + R_2}",
