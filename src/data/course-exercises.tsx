    ...
    exercises: [
      {
        ...
        problem: (
          <div className="space-y-4">
            <p>
              The role of the processor in a computer is: (choose the correct
              answers based on Series 03)
            </p>
        ...
        solution: (
          <div className="space-y-4">
            <p>
              <strong>Correct Answers: B, C, and E</strong>
            </p>
            <p>
              The processor (CPU) acts as the brain of the computer. Its primary
              functions are to <strong>carry out instructions</strong> via the
              ALU, and to <strong>order all units</strong> and{" "}
              <strong>control the progress of operations</strong> via the
              Control Unit.
            </p>
            <p className="text-muted-foreground text-sm">
              Note: It does not transfer bulk information (that's the
              bus/chipset) nor does it store instructions long-term (that's the
              hard drive/RAM).
            </p>
          </div>
        ),
