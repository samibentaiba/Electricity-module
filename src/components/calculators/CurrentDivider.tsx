        ...
        <div className="bg-slate-950 p-6 rounded-2xl flex flex-col relative overflow-hidden border border-slate-800 shadow-inner min-h-[450px]">
          ...
          <div className="flex-1 w-full h-full">
            <Mafs zoom={false} pan={false} viewBox={{ x: [-3, 3], y: [-3, 3] }}>
              ...
              <Text x={-2.8} y={0.3} color={Theme.orange} size={16}>
                I_in
              </Text>
              <Text x={-2.8} y={-0.3} color={Theme.orange} size={14}>
                {iin}A
              </Text>
              ...
              <Line.Segment
                ...
                weight={2}
              />
              {drawResistor(1, 1, true, "R2", Theme.violet, `${r2}Ω`)}
              <Line.Segment
                point1={[1, 0.25]}
                point2={[1, -2]}
                color={Theme.foreground}
              ...
              <Polygon
                ...
                color={Theme.orange}
              />
              <Text x={-1.1} y={2.5} color={Theme.orange} size={14}>
                {iin}A
              </Text>
              ...
              <Polygon
                ...
                color={Theme.indigo}
              />
              <Text x={-1.2} y={0} color={Theme.indigo} size={14}>
                I1 = {i1.toFixed(2)}A
              </Text>
              ...
              <Polygon
                ...
                color={Theme.violet}
              />
              <Text x={0.3} y={0} color={Theme.violet} size={14}>
                I2 = {i2.toFixed(2)}A
              </Text>
            </Mafs>
          </div>
        ...
        <div className="flex flex-col gap-6 bg-slate-900/50 p-6 rounded-xl border border-slate-800 justify-center">
          <div className="flex flex-col gap-2">
            ...
            <Slider
              ...
              step={1}
              value={[iin]}
              onValueChange={(val) => setIin(Array.isArray(val) ? val[0] : val)}
          ...
          <div className="mt-4 pt-4 border-t border-slate-800 flex justify-around">
            <div className="text-center">
              <p className="text-sm text-slate-500 uppercase tracking-wider font-bold mb-2">
                I1 Output
              </p>
