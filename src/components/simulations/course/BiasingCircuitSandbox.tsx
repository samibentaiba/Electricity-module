      ...
      <>
        {segments.slice(0, -1).map((p1, i) => (
          <Line.Segment
            ...
            point2={segments[i + 1] as [number, number]}
            color="#94a3b8"
            weight={3}
          />
        ))}
          ...
          <div className="space-y-4">
            ...
            <div>
              ...
              <input
                ...
                className="w-full h-2 bg-slate-700 rounded-lg appearance-none accent-amber-500"
              />
            </div>
            ...
            {(biasType === "two-source" ||
              ...
              <div>
                ...
                <input
                  ...
                  step="10"
                  value={rb}
                  onChange={(e) => setRb(parseInt(e.target.value))}
                  className="w-full h-2 bg-slate-700 rounded-lg appearance-none accent-amber-500"
                />
              </div>
            )}
      ...
      <div className="p-8 md:w-2/3 flex items-center justify-center min-h-[500px] bg-slate-950 relative overflow-hidden">
        ...
        >
          ...
          {(biasType === "fixed" ||
            ...
            <>
              <Line.Segment
                ...
                weight={4}
              />
              <Text x={0} y={4.5} color="#3b82f6" size={16}>
                V_CC = {vcc}V
              </Text>
            </>
          )}
          ...
          <Line.Segment
            ...
            weight={2}
          />
          <Text x={-1} y={0.3} color="#94a3b8" size={12}>
            B
          </Text>
          <Text x={1.2} y={1.2} color="#94a3b8" size={12}>
            C
          </Text>
          <Text x={1.2} y={-1.2} color="#94a3b8" size={12}>
            E
          ...
          <Text x={1.6} y={2} color="#94a3b8" size={14}>
            R_C
          </Text>
          <Line.Segment
            point1={[1, 2.5]}
          ...
          {biasType === "divider" ? (
            <>
              <Line.Segment
                ...
                weight={2}
              />
              {drawResistor(1, -1.5, false)}{" "}
              {/* Wait, should be vertical. Let's adjust coords. */}
          ...
          {biasType === "divider" && (
            <>
              ...
              <Text x={1.6} y={-1.5} color="#94a3b8" size={14}>
                R_E
              </Text>
              <Line.Segment
                point1={[1, -1]}
          ...
          {biasType === "two-source" && (
            <>
              ...
              <Text x={-2.5} y={0.5} color="#94a3b8" size={14}>
                R_B
              </Text>
              <Line.Segment
                point1={[-3, 0]}
              ...
              <Line.Segment
                ...
                weight={2}
              />
              <Text x={-4} y={-1.6} color="#3b82f6" size={14}>
                V_BB
              </Text>
              ...
              <Line.Segment
                ...
                weight={3}
              />
              <Text x={1.6} y={3.4} color="#3b82f6" size={14}>
                V_CC
              </Text>
            </>
          )}
          {biasType === "fixed" && (
            <>
              ...
              <Text x={-2.5} y={1.5} color="#94a3b8" size={14}>
                R_B
              </Text>
              <Line.Segment
                point1={[-2, 2]}
          ...
          {biasType === "feedback" && (
            <>
              ...
              <Text x={-0.5} y={2} color="#94a3b8" size={14}>
                R_B
              </Text>
              <Line.Segment
                point1={[0, 1.5]}
          ...
          {biasType === "divider" && (
            <>
              ...
              <Text x={-2.5} y={2} color="#94a3b8" size={14}>
                R_1
              </Text>
              <Line.Segment
                point1={[-2, 2.5]}
              ...
              <Text x={-2.5} y={-1} color="#94a3b8" size={14}>
                R_2
              </Text>
              <Line.Segment
                point1={[-2, -1.5]}
